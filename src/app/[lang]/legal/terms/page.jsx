...
export async function generateMetadata({ params }) {
  ...
  return {
    title: "Terms of use",
    description: "Terms of use for the KJC Capital website. Nothing on this site is an offer to the public or the terms on which the firm manages an account.",
  ...
  return (
    <LegalPage label="Legal" title="Terms of use" updated="17 September 2026">
      <p>
        ...
        terms on which the firm manages an account; those are set out in the client agreement,
        furnished to prospective clients by introduction.
      </p>
      ...
      <p>
        ...
        invitation to invest, a recommendation, or investment advice. The programme is
        available only to persons the firm has satisfied itself are eligible, and only by
        direct introduction.
      </p>
      <h3 className="serif text-xl mt-10 mb-3 text-[var(--color-ink)]">Eligibility</h3>
      <p>
        Access to the investor portal is available only to existing clients of the firm. The
        firm does not accept United States persons within the meaning of Regulation S as
        clients, and will not respond to enquiries that indicate US residence, US citizenship,
        or a US taxable presence.
      </p>
      <h3 className="serif text-xl mt-10 mb-3 text-[var(--color-ink)]">Intellectual property</h3>
      <p>
        The content of the site, the firm name, and the mark used with it are
