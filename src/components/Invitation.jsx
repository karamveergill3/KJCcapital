...
export default function Invitation({ lang, label, title, body, cta, signoff }) {
  return (
    <section className="mx-auto max-w-6xl px-6 md:px-10 py-20 md:py-28 border-t border-[var(--color-rule)]">
      <Reveal className="relative border border-[var(--color-rule-strong)] bg-[var(--color-paper-white)] p-10 md:p-16 paper-grain">
        ...
        <div
          className="absolute -top-2 -left-2 w-4 h-4 border-t border-l border-[var(--color-gold)]"
          aria-hidden
        />
        <div
          className="absolute -top-2 -right-2 w-4 h-4 border-t border-r border-[var(--color-gold)]"
          aria-hidden
        />
        <div
          className="absolute -bottom-2 -left-2 w-4 h-4 border-b border-l border-[var(--color-gold)]"
          aria-hidden
        />
        <div
          className="absolute -bottom-2 -right-2 w-4 h-4 border-b border-r border-[var(--color-gold)]"
          aria-hidden
        />
      </Reveal>
    </section>
